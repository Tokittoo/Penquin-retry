...
1. First, initialize Vink in your project (if you haven't already). Choose your weapon of choice:

<InstallationCommand command={'init'} />

2. This will magically create a vink.config.json file in the root of your project.
...
2. Customize your Vink components
