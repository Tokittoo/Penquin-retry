  ...
  return (
    <div className="w-full">
      ...
      <div className="text-center mb-8">
        <h2 className="text-3xl font-bold mb-4">Bug Hunting Writeups Collection</h2>
        <p className="text-muted-foreground max-w-2xl mx-auto">
          Learn from real-world vulnerability discoveries and security research. These writeups showcase proven methodologies, 
          exploitation techniques, and the thought processes behind successful bug bounty reports.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
        <div className="text-center p-4 rounded-lg bg-primary/5 border border-primary/20">
          <div className="text-2xl font-bold text-primary">{writeups.length}</div>
          <div className="text-sm text-muted-foreground">Total Writeups</div>
        </div>
        <div className="text-center p-4 rounded-lg bg-green-500/5 border border-green-500/20">
          <div className="text-2xl font-bold text-green-600">CVE Reports</div>
          <div className="text-sm text-muted-foreground">Zero-day Discoveries</div>
        </div>
        <div className="text-center p-4 rounded-lg bg-blue-500/5 border border-blue-500/20">
          <div className="text-2xl font-bold text-blue-600">Methodologies</div>
